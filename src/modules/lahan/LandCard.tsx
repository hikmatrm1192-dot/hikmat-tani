      ...
      <div className="flex items-start justify-between gap-3">
        <div className="min-w-0">
          <div className="flex items-center gap-2 flex-wrap">
            ...
            {isArchived ? (
              <span className="inline-flex items-center gap-1 px-2 py-0.5 bg-slate-200 text-slate-700 text-[10px] font-bold rounded-md border border-slate-300">
                <Archive className="w-3 h-3 text-slate-500" />
                Diarsipkan
              </span>
            ) : isSelected ? (
              <span className="inline-flex items-center gap-1 px-2 py-0.5 bg-emerald-100 text-emerald-800 text-[10px] font-bold rounded-md border border-emerald-300">
        ...
        <div className="flex items-center gap-1.5 shrink-0">
          ...
          {onManageLand && (
            <button
              ...
              title="Kelola Lahan"
              className="p-2 rounded-xl text-slate-500 hover:text-slate-900 hover:bg-slate-100 border border-slate-200 transition-colors min-h-[36px] min-w-[36px] flex items-center justify-center"
            >
        ...
        <div className="bg-emerald-50/70 border border-emerald-200/80 rounded-xl p-3.5 space-y-2">
          ...
          <div className="pt-2 flex flex-wrap items-center justify-end gap-2">
            <button
              ...
              className="inline-flex items-center gap-1 text-xs font-bold text-slate-700 hover:text-emerald-800 min-h-[40px] py-1.5 px-2.5 rounded-lg bg-white hover:bg-emerald-50 border border-slate-200 transition-colors"
            >
            ...
            <button
              ...
              className="inline-flex items-center gap-1 text-xs font-bold text-emerald-800 hover:text-emerald-950 min-h-[40px] py-1.5 px-3 rounded-lg bg-emerald-100 hover:bg-emerald-200/80 transition-colors"
            >
